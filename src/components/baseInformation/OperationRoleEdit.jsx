...
const OperationRoleEdit = ({ record, staffList = [], roles = [], onCancel }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setSuccess(false);
    try {
      await request("PUT", `/api/operationstaffs/${record.operationRoleId}`, {
  ...
  return (
    ...
    >
      <HeaderBar title={t("operationRole.editTitle", "Edit Operation Role")} sx={{ mb: 1 }} />
...
export default OperationRoleEdit;
