    ...
    >
      ...
      >
        {loading || !rowsReady ? (
          ...
          >
            <Box sx={{ minWidth: 380 + timelineWidth }}>
              <Box
                sx={{
                  display: "grid",
                  gridTemplateColumns: `380px ${timelineWidth}px`,
                ...
                >
                  ...
                  >
                    {activeCols.map((col) => {
                      ...
                      const detailsTable = getSkillUsageDetailsTable(row, col);
                      return (
                        <Tooltip
                          key={`${row.key}-${col.key}`}
                          title={detailsTable}
...
export default SkillOverviewDialog;
