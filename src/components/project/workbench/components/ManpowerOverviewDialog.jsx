    ...
    >
      ...
      >
        {loading || !rowsReady ? (
          ...
          >
            <Box sx={{ minWidth: 360 + timelineWidth }}>
              <Box
                sx={{
                  display: "grid",
                  gridTemplateColumns: `360px ${timelineWidth}px`,
                  ...
                  >
                    {activeCols.map((col) => {
                      ...
                      return (
                        <Tooltip
                          key={`${row.key}-${col.key}`}
                          title={getManpowerUsageDetailsTable(row, col)}
                          arrow
                          placement="top"
...
export default ManpowerOverviewDialog;
